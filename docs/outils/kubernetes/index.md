...
* [helm](../helm/README.md)
* [kubernetes-dasboard](https://github.com/kubernetes/dashboard#readme)

## Pods

Le concept de [Pods](https://kubernetes.io/docs/concepts/workloads/pods/) est introduit dans les slides du cours [DevOps avec Kubernetes](https://mborne.github.io/cours-devops/kubernetes.html) et à l'aide d'exemples ([mborne/k8s-exemples - Pod](https://github.com/mborne/k8s-exemples#pod)).
...
c.f. [kubernetes.io - Authenticating](https://kubernetes.io/docs/reference/access-authn-authz/authentication/) qui présente le modèle utilisateur (`username: string`, `groups: string[]`,...) et le concept de ***ServiceAccount***.
