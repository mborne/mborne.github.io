...
* Le fichier `docker-compose.yml` définit les ressources (services, volumes, réseaux).
* `docker compose` charge ce fichier et assure la création et le démarrage des ressources en une seule commande.
