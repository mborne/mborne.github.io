...
* [boost-serialization](http://www.boost.org/doc/libs/1_87_0/libs/serialization/doc/index.html) pour la **sérialisation et désérialisation des données**.
    * [examples/leveldb-kvs/README.md](https://github.com/mborne/mborne.github.io/blob/main/docs/outils/cxx/examples/leveldb-kvs/README.md)
* [boost-test](http://www.boost.org/doc/libs/1_87_0/libs/test/doc/html/index.html) pour l'écriture de **tests unitaires et fonctionnels**.
    * [examples/leveldb-kvs/test/KeyValueStoreTest.cpp](https://github.com/mborne/mborne.github.io/blob/main/docs/outils/cxx/examples/leveldb-kvs/test/KeyValueStoreTest.cpp)
...
* [boost-multi_index](https://www.boost.org/doc/libs/1_87_0/libs/multi_index/doc/index.html) pour l'**indexation sur plusieurs propriétés**.
    * [examples/boost-examples/boost-multi-index.cpp](https://github.com/mborne/mborne.github.io/blob/main/docs/outils/cxx/examples/boost-examples/boost-multi-index.cpp)
* [boost-variant](https://www.boost.org/doc/libs/1_87_0/doc/html/variant.html)
    * [examples/boost-examples/boost-variant-binary-visitor.cpp](https://github.com/mborne/mborne.github.io/blob/main/docs/outils/cxx/examples/boost-examples/boost-variant-binary-visitor.cpp)
* [boost-python](https://www.boost.org/doc/libs/1_87_0/libs/python/doc/html/tutorial/index.html)
    * [examples/boost-python-helloworld/README.md](https://github.com/mborne/mborne.github.io/blob/main/docs/outils/cxx/examples/boost-python-helloworld/README.md)

## Traitement de graphe

* [boost-graph](http://www.boost.org/doc/libs/1_87_0/libs/graph/doc/index.html)
    * [examples/boost-examples/boost-graph-helloworld.cpp](https://github.com/mborne/mborne.github.io/blob/main/docs/outils/cxx/examples/boost-examples/boost-graph-helloworld.cpp)
...
* [GDAL](http://www.gdal.org/) est un bibliothèque d'abstraction sur les données géographiques (image et vecteur) supportant de nombreux formats et de nombreux systèmes.
    * [examples/cgal-helloworld/main.cpp](https://github.com/mborne/mborne.github.io/blob/main/docs/outils/cxx/examples/cgal-helloworld/main.cpp)
...
* [GMP - The GNU Multiple Precision Arithmetic Library](https://gmplib.org/)
    * [examples/gmpxx-bench-sum/main.cpp](https://github.com/mborne/mborne.github.io/blob/main/docs/outils/cxx/examples/gmpxx-bench-sum/main.cpp)
    * [examples/gmpxx-helloworld/main.cpp](https://github.com/mborne/mborne.github.io/blob/main/docs/outils/cxx/examples/gmpxx-helloworld/main.cpp)
