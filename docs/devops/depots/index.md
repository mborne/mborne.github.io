...
Cette page recense les dépôts utilisés dans le [cours d'introduction à DevOps](https://mborne.github.io/cours-devops/).

## La présentation et ses annexes

* [github.com - mborne/cours-devops](https://github.com/mborne/cours-devops#readme) contient les sources de la présentation.
...
* [github.com - mborne/geostack-deploy/kubernetes](https://github.com/mborne/geostack-deploy/tree/master/kubernetes#readme) : dépôt pour déploiement de l'exemple GeoStack du cours avec Kubernetes.
