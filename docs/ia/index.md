...
* [mborne/numpy-experiments](https://github.com/mborne/numpy-experiments#readme) (Python, Jupyter notebooks)

## LLM

### Comprendre les LLM

* [Les LLM - principe de fonctionnement et concepts avancées](llm/index.md)
