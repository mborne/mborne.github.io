...
* [blog.stephane-robert.info - Formation DevOps](https://blog.stephane-robert.info/docs/) propose un parcours d'apprentissage complet et des documentations détaillées.
* [roadmap.sh - DevOps Roadmap](https://roadmap.sh/devops) propose un chemin d'apprentissage permettant de découvrir les principaux concepts et outils qu'un DevOps est amené à rencontrer
...
* [DevOps - Les 12 facteurs](../../12-facteurs/index.md)
...
Nous n'abordons pas DevSecOps dans le [cours d'introduction à la méthode DevOps](https://mborne.github.io/cours-devops), mais vous noterez que :
